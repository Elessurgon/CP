...
void solve() {
    ...
    double ans = 0;
    if (a[0].s == a[1].s && a[1].s != 0 && a[2].s < a[1].s) {
        cout << setprecision(20) << sqrt((a[0].f - a[1].f) * (a[0].f - a[1].f)) << endl;
    } else if (a[0].s == a[2].s && a[0].s != 0 && a[1].s < a[0].s) {
        cout << setprecision(20) << sqrt((a[0].f - a[2].f) * (a[0].f - a[2].f)) << endl;
    } else if (a[1].s == a[2].s && a[1].s != 0 && a[0].s < a[1].s) {
        cout << setprecision(20) << sqrt((a[1].f - a[2].f) * (a[1].f - a[2].f)) << endl;
    } else {
